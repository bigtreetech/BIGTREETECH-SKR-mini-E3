...
//
  ...
  #include "stm32/pins_BIGTREE_SKR_MINI_E3.h"   // STM32F1                                env:BIGTREE_SKR_MINI / BIGTREE_SKR_MINI_512KB
#elif MB(BTT_SKR_MINI_E3_V1_1)
  #include "stm32/pins_BTT_SKR_MINI_E3_V1_1.h"  // STM32F1                                env:BIGTREE_SKR_MINI_512KB
#elif MB(BIGTREE_SKR_E3_DIP)
  #include "stm32/pins_BIGTREE_SKR_E3_DIP.h"    // STM32F1                                env:BIGTREE_SKR_MINI / BIGTREE_SKR_MINI_512KB
