...
#define BOARD_BIGTREE_SKR_MINI_E3     4011  // BigTreeTech SKR Mini E3 (STM32F103RC/STM32F103RE)
#define BOARD_BTT_SKR_MINI_E3_V1_1    4012  // BigTreeTech BTT SKR Mini E3 V1.1 (STM32F103RE)
