...
#define STRING_CONFIG_H_AUTHOR "(BIGTREE-TECH, SKR_mini_E3_V1)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V1_1
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "mini_E3_V1"
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 40       // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
