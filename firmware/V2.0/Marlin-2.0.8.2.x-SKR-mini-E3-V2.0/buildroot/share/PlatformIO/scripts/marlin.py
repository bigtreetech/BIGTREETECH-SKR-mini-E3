...
def replace_define(field, value):
    # Find all defines that match the field to be removed
    to_remove = [define for define in env['CPPDEFINES'] if define[0] == field]

    # Remove the matched defines
    for define in to_remove:
        env['CPPDEFINES'].remove(define)

    # Append the new define
